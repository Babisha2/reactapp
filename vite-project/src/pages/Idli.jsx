...
import idli1 from '../assets/pictures/idli1.jpg';
import idli2 from '../assets/pictures/idli2.jpg';
import idli3 from '../assets/pictures/idli3.jpg';
import idli4 from '../assets/pictures/idli4.jpg';
    ...
    <div>
      ...
      <h5 className="mb-3">Restaurants to explore</h5>
        <div className="scrolling-wrapper d-flex flex-nowrap">
          <div className="card">
            <img src={idli1} class="card-img-top" alt="Curry Home"/>
          ...
          <div className="card position-relative">
            <img src={idli2} class="card-img-top" alt="Singhar"/>
            <div className="card-body">
          ...
          <div className="card position-relative">
            <img src={idli3} class="card-img-top" alt="Time Pass"/>
            <div className="card-body">
          ...
          <div className="card">
            <img src={idli4} class="card-img-top" alt="Mummy Daddy"/>
            <div className="card-body">
